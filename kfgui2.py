...
counter = {"correct":0,"wrong":0,"incomplete":0,"partially wrong":0}
tonals = {"a1":"ā","a2":"á","a3":"ǎ","a4":"à","e1":"ē","e2":"é","e3":"ě","e4":"è","i1":"ī","i2":"í","i3":"ǐ","i4":"ì","o1":"ō","o2":"ó","o3":"ǒ","o4":"ò","u1":"ū","u2":"ú","u3":"ǔ","u4":"ù","v1":"ǖ","v2":"ǘ","v3":"ǚ","v4":"ǜ"}
run = True
def stats(dct):
    text = ""
    for key in dct:
...
def _feedback(correct_a,user_a_entry,window):
    ...
    fbdict = {"correct":['Correct!','Great job!','Keep it up!','Yes!'],"wrong":['Wrong! Try again!','Oops!','Nope!'],"incomplete":"Correct, but it has more meanings!"}
    if correct_a == user_a:
